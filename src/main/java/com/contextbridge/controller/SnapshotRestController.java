 ...
 * <p>Endpoints:
 * <ul>
 *   <li>{@code GET  /api/snapshots?project=...} — list snapshots (optionally filtered by project).</li>
 *   <li>{@code GET  /api/snapshots/restore?project=...} — get best snapshot for a project.</li>
 *   <li>{@code POST /api/snapshots} — save a new snapshot (convenience alias for checkpoint).</li>
 * </ul>
 */
@Slf4j
@RestController
